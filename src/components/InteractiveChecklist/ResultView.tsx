          ...
          <div className="bg-white p-6 sm:p-8 rounded-3xl shadow-[0_8px_30px_rgba(0,0,0,0.06)] border border-slate-200 sticky top-24 text-center">
            ...
            {state === "success" ? (
              ...
              <form onSubmit={handleSubmit} onFocusCapture={trackStartOnce} className="mb-5 space-y-3 text-left">
                ...
                <label className="flex items-start gap-2 text-xs text-slate-600"><input required type="checkbox" checked={formData.privacy_accepted} onChange={e => setFormData({...formData, privacy_accepted: e.target.checked})} className="mt-0.5 h-4 w-4 accent-[#302B7B] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FF206E]" /><span>Acepto la <a href="/privacidad" className="rounded-sm font-semibold text-[#302B7B] underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FF206E]">política de privacidad</a> para recibir esta copia.</span></label>
